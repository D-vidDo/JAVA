		...
		public void actionPerformed(ActionEvent e) {
			...
			if (actionCommand.equals("Find Flights")) {
				...
				try {
					...
					Reservation rev = ReservationManager.makeReservation(flightsList.getSelectedValue(), nameTextField.getText(),
							citzTextField.getText());
					ReservationManager.getReservations().add(rev);
					JOptionPane.showMessageDialog(null, "Reservation Created. Your code is " + ReservationManager.generateReservationCode());
