...
public class FlightsTab extends TabBase {
	...
	private JPanel createCenterPanel() {
		...
		dayComboBox.addItem(manager.WEEKDAY_ANY);
		dayComboBox.addItem(manager.WEEKDAY_MONDAY);
		dayComboBox.addItem(manager.WEEKDAY_TUESDAY);
		dayComboBox.addItem(manager.WEEKDAY_WEDNESDAY);
		dayComboBox.addItem(manager.WEEKDAY_THURSDAY);
		dayComboBox.addItem(manager.WEEKDAY_FRIDAY);
		dayComboBox.addItem(manager.WEEKDAY_SATURDAY);
		dayComboBox.addItem(manager.WEEKDAY_SUNDAY);
	...
	private class ButtionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (actionCommand.equals("Find Flights")) {
				...
				for (Flight i : manager.findFlights(from, to, day)) {
