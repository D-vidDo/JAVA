...
public class FlightsTab extends TabBase {
	 ...
	 */
	public FlightsTab(FlightManager manager, ReservationManager resManager) {
	...
	private class ButtionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (actionCommand.equals("Find Flights")) {
				...
				try {
					Reservation rev = resTemp.makeReservation(flightsList.getSelectedValue(), nameTextField.getText(),
